...
class _CartViewState extends State<CartView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: _AddressesListScreen(onBack: widget.onBack),
      ),
    );
  }
}

/// Screen 1: قائمة العناوين (middle screenshot).
class _AddressesListScreen extends StatelessWidget {
  const _AddressesListScreen({this.onBack});
...
/// Screen 2: تفاصيل العنوان + الباقة (first screenshot).
...
/// Screen 3: صندوق بريدي (third screenshot, simplified).
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _FeatureRow(
                    text: 'عنوان ثابت خاص بك (مثل صندوق بريد أمريكي).',
                  ),
                  _FeatureRow(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ExpansionTile(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'نعم، عنوان حقيقي يمكنك استخدامه لاستقبال بريدك.',
                          style: AppStyles.styleRegular12(context),
                        ),
                      ),
                    ],
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(
                            bottom: 8, right: 4, left: 4),
                        child: Text(
                          'يعتمد على متطلبات الجهة الرسمية في بلدك.',
                          style: AppStyles.styleRegular12(context),
                        ),
                      ),
                    ],
                  ...
                  ExpansionTile(
                    tilePadding: EdgeInsets.zero,
                    title: Text(
                      'هل أقدر أستلم من كل شركات الشحن؟',
                      style: AppStyles.styleSemiBold14(context),
                    ),
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(
                            bottom: 8, right: 4, left: 4),
                        child: Text(
                          'يمكنك استقبال الشحنات من معظم شركات الشحن العالمية.',
                          style: AppStyles.styleRegular12(context),
                        ),
                      ),
                    ],
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(
                            bottom: 8, right: 4, left: 4),
                        child: Text(
                          'الخطة مرنة ويمكن إلغاؤها وفقاً لشروط الاستخدام.',
                          style: AppStyles.styleRegular12(context),
                        ),
                      ),
                    ],
